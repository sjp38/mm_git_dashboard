...
- mm-hotfixes-unstable: 2 total, 0 (0) series, 2 non-series commits
  ...
  - full commits list
    ...
    - a3df88bd753c mm/kfence: disable KFENCE upon KASAN HW tags enablement
...
- mm-new: 44 total, 2 (32) series, 12 non-series commits
  ...
  - full commits list
    ...
    - 1d7b4932bdba mm/damon/ops-common: remove redudnant mmu notifier call in pmdp mkold
      - Authored by no role player, reviewed by a maintainer
    ...
    - 00ac51053f09 fs: hugetlb: simplify remove_inode_hugepages() return type
      - Authored by no role player, reviewed by a maintainer
    ...
    - series "KSM: Optimizations for rmap_walk_ksm", v3. (2 commits)
      - 71a492246143 ksm: initialize the addr only once in rmap_walk_ksm (0/2)
        - Authored by no role player, reviewed by no role player
      ...
      - 3958e2e5a65b ksm: optimize rmap_walk_ksm by passing a suitable address range (1/2)
        - Authored by no role player, reviewed by no role player
    ...
    - series "maple_tree: Replace big node with maple copy", v3. (30 commits)
      - 9e62a9b5aa08 maple_tree: fix mas_dup_alloc() sparse warning (0/30)
        - Authored by a maintainer, reviewed by nobody
      ...
      - d55ea8e6af45 maple_tree: move mas_spanning_rebalance loop to function (1/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-3-Liam.Howlett@oracle.com
      - aca507a70a47 maple_tree: extract use of big node from mas_wr_spanning_store() (2/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-4-Liam.Howlett@oracle.com
      - fa6781ec3d01 maple_tree: remove unnecessary assignment of orig_l index (3/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-5-Liam.Howlett@oracle.com
      - 06527aab5dcc maple_tree: inline mas_spanning_rebalance() into mas_wr_spanning_rebalance() (4/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-6-Liam.Howlett@oracle.com
      - dc80ed1f2137 maple_tree: make ma_wr_states reliable for reuse in spanning store (5/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-7-Liam.Howlett@oracle.com
      - 676fd025586a maple_tree: remove l_wr_mas from mas_wr_spanning_rebalance (6/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-8-Liam.Howlett@oracle.com
      - 3dc718f33423 maple_tree: don't pass through height in mas_wr_spanning_store (7/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-9-Liam.Howlett@oracle.com
      - da76382784ff maple_tree: move maple_subtree_state from mas_wr_spanning_store to mas_wr_spanning_rebalance (8/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-10-Liam.Howlett@oracle.com
      - 04f791031efa maple_tree: correct right ma_wr_state end pivot in mas_wr_spanning_store() (9/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-11-Liam.Howlett@oracle.com
      - ef0413a488e5 maple_tree: introduce maple_copy node and use it in mas_spanning_rebalance() (10/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-12-Liam.Howlett@oracle.com
      - 44bc7d153662 maple_tree: testing update for spanning store (11/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-13-Liam.Howlett@oracle.com
      - 9504cf18a713 maple_tree: inline mas_spanning_rebalance_loop() into mas_wr_spanning_rebalance() (12/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-14-Liam.Howlett@oracle.com
      - c436a02a28f9 maple_tree: change initial big node setup in mas_wr_spanning_rebalance() (13/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-15-Liam.Howlett@oracle.com
      - 2e543e583a7d maple_tree: introduce ma_leaf_max_gap() (14/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-16-Liam.Howlett@oracle.com
      - 48f8c77dd9db maple_tree: add gap support, slot and pivot sizes for maple copy (15/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-17-Liam.Howlett@oracle.com
      - 4dcac4d7179f maple_tree: start using maple copy node for destination (16/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-18-Liam.Howlett@oracle.com
      - 164d89536246 maple_tree-start-using-maple-copy-node-for-destination-checkpatch-fixes (17/30)
        - Authored by a maintainer, reviewed by nobody
      - cd5c699fe26c maple_tree: inline mas_wr_spanning_rebalance() (18/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-19-Liam.Howlett@oracle.com
      - ac083298376e maple_tree: remove unnecessary return statements (19/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-20-Liam.Howlett@oracle.com
      - a3bd91cbbbf0 maple_tree: separate wr_split_store and wr_rebalance store type code path (20/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-21-Liam.Howlett@oracle.com
      - f1266361dc21 maple_tree: add cp_is_new_root() helper (21/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-22-Liam.Howlett@oracle.com
      - 1a2c3c92b91e maple_tree-add-cp_is_new_root-helper-fix (22/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/malwmirqnpuxqkqrobcmzfkmmxipoyzwfs2nwc5fbpxlt2r2ej@wchmjtaljvw3
      - f04c21a17432 maple_tree-add-cp_is_new_root-helper-fix-fix (23/30)
        - Authored by a maintainer, reviewed by nobody
      - dd62afcc04c3 maple_tree: use maple copy node for mas_wr_rebalance() operation (24/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-23-Liam.Howlett@oracle.com
      - da32519a7a4f maple_tree: add test for rebalance calculation off-by-one (25/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-24-Liam.Howlett@oracle.com
      - 860091e8c5c6 maple_tree: add copy_tree_location() helper (26/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-25-Liam.Howlett@oracle.com
      - e40b4ed89dd5 maple_tree: add cp_converged() helper (27/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-26-Liam.Howlett@oracle.com
      - f22eef5098b7 maple_tree: use maple copy node for mas_wr_split() (28/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-27-Liam.Howlett@oracle.com
      - ffa3fbe1f561 maple_tree: remove maple big node and subtree structs (29/30)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lkml.kernel.org/r/20260130205935.2559335-28-Liam.Howlett@oracle.com
    - 0d49bfb782b2 maple_tree: pass maple copy node to mas_wmb_replace()
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lkml.kernel.org/r/20260130205935.2559335-29-Liam.Howlett@oracle.com
    - 8e99610a82a0 maple_tree: don't pass end to mas_wr_append()
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lkml.kernel.org/r/20260130205935.2559335-30-Liam.Howlett@oracle.com
    - 25d885e5461c maple_tree: clean up mas_wr_node_store()
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lkml.kernel.org/r/20260130205935.2559335-31-Liam.Howlett@oracle.com
    - 00d807578c50 arm64: mm: fix pass user prot to ioremap_prot in generic_access_phys
      - Authored by no role player, reviewed by a maintainer

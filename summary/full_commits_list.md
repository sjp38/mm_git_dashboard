...
- mm-hotfixes-unstable: 20 total, 2 (4) series, 16 non-series commits
  ...
  - full commits list
    ...
    - 65a1c53713bc "scripts/gdb: mm: cast untyped symbols in x86_page_ops"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260427142448.666117-2-illia@yshyn.com
    - 95f1ce6367cd "scripts/gdb: slab: update field names of struct kmem_cache"
      - Authored by no role player, reviewed by no role player
    ...
    - series "MAINTAINERS: update KEXEC, KDUMP and LIVE UPDATE". (2 commits)
      - fb68bc0fc7f3 "MAINTAINERS: add tree for KDUMP and KEXEC" (0/2)
        - Authored by no role player, reviewed by no role player
      ...
      - 7e8051b5dea6 "MAINTAINERS: add kexec@ list to LIVE UPDATE ENTRY" (1/2)
        - Authored by no role player, reviewed by no role player
    ...
    - 611211e19490 "mm-page_alloc-fix-initialization-of-tags-of-the-huge-zero-folio-with-init_on_free-fix"
      - Authored by a maintainer, reviewed by nobody
    - a23fdc9d82e3 "lib: kunit_iov_iter: fix test fail on powerpc"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260421070707.992873-1-lk@c--e.de
    - 6039d06e2514 "sh: fix fallout from ZERO_PAGE consolidation"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260417103208.1217010-1-rppt@kernel.org
    - e4a84e4a074b "device-dax: fix refcount leak in __devm_create_dev_dax() error path"
      - Authored by no role player, reviewed by nobody
...
- mm-new: 96 total, 15 (74) series, 22 non-series commits
  ...
  - full commits list
    ...
    - series "treewide: fixup gfp_t printks", v2. (3 commits)
      - 5c69538868f9 "drm/managed: use special gfp_t format specifier" (0/3)
        - Authored by no role player, reviewed by nobody
      ...
      - 0eabc7fe6334 "net/rds: use special gfp_t format specifier" (2/3)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260326-gfp64-v2-4-d916021cecdf@google.com
    - efdfaecf8143 "dax/kmem: account for partial discontiguous resource upon removal"
      - Authored by no role player, reviewed by no role player
    ...
    - series "use vma locks for proc/pid/{smaps|numa_maps} reads", v2. (3 commits)
      ...
      - 51188e9111e0 "selftests/proc: ensure the test is performed at the right page boundary" (1/3)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260426062718.1238437-3-surenb@google.com
      - 3fe88ca0e42f "selftests/proc: add /proc/pid/smaps tearing tests" (2/3)
        - Authored by no role player, reviewed by no role player
    ...
    - series "mm: remove page_mapped()". (3 commits)
      - 47c9b81b5989 "sh: use folio_mapped() instead of page_mapped() in sh4_flush_cache_page()" (0/3)
        - Authored by no role player, reviewed by no role player
      ...
      - 489831edc0bb "bpf: arena: use page_ref_count() instead of page_mapped() in arena_free_pages()" (1/3)
        - Authored by no role player, reviewed by no role player
    ...
    - series "kasan: hw_tags: Disable tagging for stack and page-tables", v4. (3 commits)
      ...
      - d4854e5ba631 "mm: skip KASAN tagging for page-allocated page tables" (2/3)
        - Authored by no role player, reviewed by no role player
    ...
    - series "Remove CONFIG_READ_ONLY_THP_FOR_FS and enable file THP for writable files", v5. (14 commits)
      ...
      - ea3aca641daf "fs: remove nr_thps from struct address_space" (6/14)
        - Authored by no role player, reviewed by no role player
      ...
      - 4f8ab7f1084f "fs/btrfs: remove a comment referring to READ_ONLY_THP_FOR_FS" (9/14)
        - Authored by no role player, reviewed by a maintainer
...
- mm-nonmm-unstable: 52 total, 7 (32) series, 20 non-series commits
  ...
  - full commits list
    ...
    - series "taskstats: fix TGID dead-thread stat retention", v3. (2 commits)
      - 5fd6fb98b796 "taskstats: retain dead thread stats in TGID queries" (0/2)
        - Authored by no role player, reviewed by no role player
      ...
      - 0c395a60c450 "selftests/acct: add taskstats TGID retention test" (1/2)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/0d55354911c54cd1b9f10a09f6fd378af85c8d43.1776094300.git.cyyzero16@gmail.com
    - 713d0b04267d "gcov: use atomic counter updates to fix concurrent access crashes"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260422125112.3583649-2-khorenko@virtuozzo.com
    - 17531d4e13ba "seq_buf: export seq_buf_putmem_hex() and add KUnit tests"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260408202351.21829-1-shuvampandey1@gmail.com
    - 3e2ac2d33733 "get_maintainer: add --json output mode"
      - Authored by no role player, reviewed by a maintainer
    ...
    - series "lib/tests: string_helpers: Slight improvements". (2 commits)
      - 16fbd359efad "lib/tests: string_helpers: decouple unescape and escape cases" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - 6e9adc7b7d69 "lib/tests: string_helpers: don't use "proxy" headers" (1/2)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260406193425.1534197-3-andriy.shevchenko@linux.intel.com
    - 2430d38b72f3 "init.h: discard exitcall symbols early"
      - Authored by no role player, reviewed by no role player
    ...
    - series "lib/base64: decode fixes", v2. (2 commits)
      - e7f690b53305 "lib/base64: validate before writing in decode tail path" (0/2)
        - Authored by no role player, reviewed by a maintainer
      ...
      - 97187ae822b3 "lib/base64: fix copy-pasted @padding doc in base64_decode()" (1/2)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260324223210.47676-3-objecting@objecting.org
    - 93300b84dfd4 "lib: split codetag_lock_module_list()"
      - Authored by no role player, reviewed by a maintainer
    ...
    - series "selftests/filelock: Make output more kselftestish", v4. (3 commits)
      - 6fbe8779088a "kselftest/filelock: use ksft_perror()" (0/3)
        - Authored by no role player, reviewed by nobody
      ...
      - ddadbb317668 "kselftest/filelock: report each test in oftlocks separately" (1/3)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260226-selftest-filelock-ktap-v4-2-db8ae192ff42@kernel.org
      - deaa431cfcca "kselftest/filelock: add a .gitignore file" (2/3)
        - Authored by no role player, reviewed by nobody
    ...
    - series "barrier: Add smp_cond_load_{relaxed,acquire}_timeout()", v11. (14 commits)
      - 5b054ed62728 "asm-generic: barrier: add smp_cond_load_relaxed_timeout()" (0/14)
        - Authored by no role player, reviewed by no role player
      ...
      - a9935ea24907 "arm64: barrier: support smp_cond_load_relaxed_timeout()" (1/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-3-ankur.a.arora@oracle.com
      - 55adff0abd64 "arm64/delay: move some constants out to a separate header" (2/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-4-ankur.a.arora@oracle.com
      - 4b2a7c735aed "arm64: support WFET in smp_cond_load_relaxed_timeout()" (3/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-5-ankur.a.arora@oracle.com
      - b96333af749b "arm64: rqspinlock: remove private copy of smp_cond_load_acquire_timewait()" (4/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-6-ankur.a.arora@oracle.com
      - d9d421a38f81 "asm-generic: barrier: add smp_cond_load_acquire_timeout()" (5/14)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260408122538.3610871-7-ankur.a.arora@oracle.com
      - f7a03cecbdce "atomic: add atomic_cond_read_*_timeout()" (6/14)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260408122538.3610871-8-ankur.a.arora@oracle.com
      - 1f2f459a858b "locking/atomic: scripts: build atomic_long_cond_read_*_timeout()" (7/14)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260408122538.3610871-9-ankur.a.arora@oracle.com
      - c4f919d7c9cc "bpf/rqspinlock: switch check_timeout() to a clock interface" (8/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-10-ankur.a.arora@oracle.com
      - 1c72ba17c574 "bpf/rqspinlock: use smp_cond_load_acquire_timeout()" (9/14)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260408122538.3610871-11-ankur.a.arora@oracle.com
      - 9625e201da8f "sched: add need-resched timed wait interface" (10/14)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260408122538.3610871-12-ankur.a.arora@oracle.com
      - fe830b24d624 "cpuidle/poll_state: wait for need-resched via tif_need_resched_relaxed_wait()" (11/14)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260408122538.3610871-13-ankur.a.arora@oracle.com
      - 15957a90983b "kunit: enable testing smp_cond_load_relaxed_timeout()" (12/14)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260408122538.3610871-14-ankur.a.arora@oracle.com
      - a39383276d59 "kunit: add tests for smp_cond_load_relaxed_timeout()" (13/14)
        - Authored by no role player, reviewed by nobody
    ...
    - series "uaccess: unify inline vs outline copy_{from,to}_user() selection", v2. (3 commits)
      - ce552a0561f9 "rust: uaccess: use INLINE_COPY_TO_USER to guard copy_to_user()" (0/3)
        - Authored by no role player, reviewed by nobody
      ...
      - abf28ded2526 "uaccess: unify inline vs outline copy_{from,to}_user() selection" (1/3)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260425020857.356850-3-ynorov@nvidia.com
      - 48fa3c903ab4 "uaccess: minimize INLINE_COPY_USER-related ifdefery" (2/3)
        - Authored by no role player, reviewed by nobody
    ...
    - d3bb60e75b52 "lib/idr: fix ida_find_first_range() missing IDs across chunk boundaries"
      - Authored by no role player, reviewed by nobody
    ...
    - series "lib and lib/cmdline enhancements", v9. (6 commits)
      - 3d9ff865a699 "lib: fix _parse_integer_limit() to handle overflow" (0/6)
        - Authored by no role player, reviewed by no role player
      ...
      - c3c89037f30d "lib: fix memparse() to handle overflow" (1/6)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260403103338.1122415-3-dmantipov@yandex.ru
      - daede1828de3 "lib: add more string to 64-bit integer conversion overflow tests" (2/6)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260403103338.1122415-4-dmantipov@yandex.ru
      - 5497e9e7da26 "lib/cmdline_kunit: add test case for memparse()" (3/6)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260403103338.1122415-5-dmantipov@yandex.ru
      - e863b2f73b35 "lib/cmdline: adjust a few comments to fix kernel-doc -Wreturn warnings" (4/6)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260403103338.1122415-6-dmantipov@yandex.ru
      - 0604832d7c76 "riscv: export symbols needed for riscv32 EFI stub" (5/6)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260403103338.1122415-7-dmantipov@yandex.ru
    - e672d8e8696b "lib/tests: extend cmdline KUnit with next_arg() tests"
      - Authored by no role player, reviewed by no role player

...
- mm-hotfixes-unstable: 26 total, 0 (0) series, 26 non-series commits
  ...
  - full commits list
    - 1a2d70a97477 "selftests/filesystems: fix missing and stale TARGETS entries"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260703150742.58991-1-disgoel@linux.ibm.com
    - 3dcf9efe978c "module: fix lost error code from codetag_load_module()"
      - Authored by no role player, reviewed by no role player
    ...
    - 2a2ca1755a18 "x86/mm: fix pmd_modify() dropping the dirty bit"
      - Authored by no role player, reviewed by no role player
    ...
    - 43b00278339b "mailmap: update Haowen Bai's email address"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260903132854.1930923-1-calvin.bai@ugreen.com
    - 37ac39054237 "ocfs2: make ocfs2_calc_xattr_init() return void"
      - Authored by a maintainer, reviewed by nobody
    ...
    - 329894f287f9 "xarray: fix index jumping backwards in xas_find()"
      - Authored by no role player, reviewed by nobody
    ...
    - afcdb4f8d992 "MAINTAINERS: add Baoquan and Baolin as MGLRU reviewers"
      - Authored by no role player, reviewed by no role player
    ...
    - 73bef808bd5a "MAINTAINERS: update Xu Xin's email"
      - Authored by no role player, reviewed by nobody
...
- mm-unstable: 511 total, 78 (418) series, 93 non-series commits
  ...
  - full commits list
    ...
    - f2c5f904581d "docs: cgroup: document empty-write behavior of memory limit knobs"
      - Authored by no role player, reviewed by no role player
    ...
    - series "arch, mm/execmem: resolve confusion about set_direct_map_valid_noflush()", v3. (6 commits)
      ...
      - 4eea4499b931 "Revert "arch: introduce set_direct_map_valid_noflush()"" (5/6)
        - Authored by no role player, reviewed by no role player
    ...
    - series "memcg: remove the v1 soft limit", v2. (8 commits)
      ...
      - c84c316e2f05 "memcg: remove the soft limit reclaim tracepoints" (2/8)
        - Authored by no role player, reviewed by no role player
      ...
      - 864b0ed9b4ea "memcg: remove the per-node soft limit tree fields" (5/8)
        - Authored by a maintainer, reviewed by no role player
    ...
    - series "mm/page_io: folio conversion cleanups", v2. (6 commits)
      ...
      - 1fbe8169d347 "mm: remove PageReclaim" (1/6)
        - Authored by no role player, reviewed by no role player
    ...
    - series "mm: Unconditional per-VMA locks and cleanups", v7. (7 commits)
      ...
      - 27834c204f58 "binder: make shrinker rely solely on per-VMA lock" (1/7)
        - Authored by no role player, reviewed by a maintainer
      ...
      - 3db190066c25 "binder: remove mmap_lock fallback" (3/7)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260831203056.838265-5-surenb@google.com
      - 4d9546d7a336 "tcp: remove mmap_lock fallback path" (4/7)
        - Authored by no role player, reviewed by no role player
    ...
    - series "mm: optimize zone-device memmap initialization", v11. (7 commits)
      ...
      - a4626a3ccba4 "string: introduce memcpy_nontemporal()" (5/7)
        - Authored by no role player, reviewed by nobody
    ...
    - c95773fbb638 "x86/string: extend memcpy_flushcache() fixed-size fastpaths"
      - Authored by no role player, reviewed by a maintainer
    ...
    - series "mm: replace PF_KCOMPACTD/PF_KSWAPD with kthread_func()". (4 commits)
      - 80495335ae69 "xfs: remove dead kswapd flag inheritance from btree split worker" (0/4)
        - Authored by no role player, reviewed by no role player
      ...
      - b36ebe3f867e "iomap: simplify writepages reclaim guard" (1/4)
        - Authored by no role player, reviewed by no role player
    ...
    - series "docs/core-api: memory-allocation: add k[mz]alloc_obj() and clarify kmalloc", v2. (2 commits)
      ...
      - a02d60a6e379 "MAINTAINERS: add memory related docs in core-mm/ to MM - MISC section" (1/2)
        - Authored by no role player, reviewed by no role player
    ...
    - series "mm: trace: decode architecture-specific VMA flags", v2. (3 commits)
      - 10cd635d13d5 "mm: trace: decode arm64 and sparc64 VM_ARCH_1 flags" (0/3)
        - Authored by no role player, reviewed by nobody
      ...
      - 04fd673c73f3 "mm: trace: decode MTE and shadow stack VMA flags" (1/3)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/1c7f7003cff8d00209baa8498f1efee113f5b5a4.1788330432.git.zhaomeijing@lixiang.com
      - aef51124c08a "mm: trace: name protection key encoding bits" (2/3)
        - Authored by no role player, reviewed by nobody
    ...
    - series "Make HWPoison helpers config-independent". (2 commits)
      - 3ec5b8a421e2 "mm/page-flags: define HWPoison test-and-change helpers unconditionally" (0/2)
        - Authored by no role player, reviewed by no role player
      ...
      - d8b22946df96 "nvdimm/pmem: remove test_and_clear_pmem_poison()" (1/2)
        - Authored by no role player, reviewed by nobody
    ...
    - ffa2b7c339d0 "mm-memory_hotplug-factor-out-node_is_memoryless-fix"
      - Authored by a maintainer, reviewed by nobody
    - 899ac56568b8 "mm: remove PageWriteback"
      - Authored by no role player, reviewed by no role player
    ...
    - series "memcg: group struct fields by access pattern". (6 commits)
      - a9853b0ad4d4 "memcg: move per-node objcg to the read-mostly fields" (0/6)
        - Authored by a maintainer, reviewed by nobody
    ...
    - series "mm: remove page_swap_entry()", v2. (8 commits)
      ...
      - 69cb16d66d7d "arm64: mte: make mte_save_tags() and mte_restore_tags() static" (6/8)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260908-folio_swap_entry-v2-6-ee6d01dfa5e1@columbia.edu
      - 44999b6207dd "arm64: mte: pass the swap entry to mte_save_tags()" (7/8)
        - Authored by no role player, reviewed by no role player
    ...
    - b3046d532726 "writeback: bound cleanup_offline_cgwb() rescans by rotating scanned inodes"
      - Authored by no role player, reviewed by a reviewer
      - Link: https://lore.kernel.org/20260911-wb-cgwb-rotate-v2-1-a9ab253a1295@gmail.com
    - 7bf1700c807d "lib: fix lock initialization in region allocation benchmark"
      - Authored by no role player, reviewed by no role player
    ...
    - series "Catch automatic storage in IDA and Maple Tree definitions". (3 commits)
      - bccaf57ef823 "compiler.h: add ASSERT_STATIC_STORAGE()" (0/3)
        - Authored by no role player, reviewed by nobody
      ...
      - 0594938850ff "idr: assert static storage for DEFINE_IDA()" (1/3)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260911221444.1523311-3-ynorov@nvidia.com
      - 6dfcbf8fa73e "maple_tree: assert static storage for DEFINE_MTREE()" (2/3)
        - Authored by no role player, reviewed by nobody
    ...
    - series "Remove PG_private by using page/folio->private", v4. (16 commits)
      ...
      - e9bee16c19c6 "xen/grant-table: stop setting PG_private on pages for grant mapping" (2/16)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-3-848550f7574e@nvidia.com
      - 5c5ba1daaed7 "fscrypt: stop setting PG_private on bounce page" (3/16)
        - Authored by no role player, reviewed by a maintainer
      ...
      - 08071592211d "f2fs: stop using PG_private" (5/16)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-6-848550f7574e@nvidia.com
      - 32e05e39cb44 "f2fs: convert the ->private flag helpers to folio-only" (6/16)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-7-848550f7574e@nvidia.com
      - f06d2bc25fc7 "erofs: mm/pagemap: add readahead_folio_last() to avoid folio->private" (7/16)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-8-848550f7574e@nvidia.com
      - 4b0a39667522 "erofs: use folio_attach/detach_private() instead of direct assignment" (8/16)
        - Authored by no role player, reviewed by a maintainer
      ...
      - b8ccc90ab69b "ceph: replace PagePrivate() with page_private()" (11/16)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-12-848550f7574e@nvidia.com
      - f02a62747d75 "md/md-bitmap: replace PagePrivate() with page_private()" (12/16)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260913-remove-pg_private-v4-13-848550f7574e@nvidia.com
      - cfb786911243 "buffer: replace page_buffer() with page_private() and delete it" (13/16)
        - Authored by no role player, reviewed by nobody
      ...
      - 766094c3f433 "mm/page-flags: remove PG_private" (15/16)
        - Authored by no role player, reviewed by no role player
...
- mm-new: 46 total, 4 (29) series, 17 non-series commits
  ...
  - full commits list
    ...
    - 218e8005ed56 "riscv: mm: fix concurrency in mark_new_valid_map()"
      - Authored by no role player, reviewed by nobody
    ...
    - 79f7c97d8aae "riscv: mm: exclude invalid THP PMDs from page table check"
      - Authored by no role player, reviewed by nobody
    ...
    - series "sh: remove NUMA and SPARSEMEM support", v2. (10 commits)
      - 8801f13e3994 "sh: remove CONFIG_NUMA and related configuration options" (0/10)
        - Authored by no role player, reviewed by no role player
...
- mm-nonmm-unstable: 98 total, 14 (43) series, 55 non-series commits
  ...
  - full commits list
    - b731e913f26d "drivers/media/v4l2-core/v4l2-vp9.c: reduce inlining"
      - Authored by no role player, reviewed by no role player
    - f461a75d847e "taskstats: copy signal->stats under siglock in taskstats_exit"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260804093400.3922-1-include@grrlz.net
    - 6b37c5d62c4e "checkpatch: skip CamelCase cache for --no-tree without root"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260810161159.1044160-1-pvorel@suse.cz
    - 649bfb7d4cb1 "USB: gadgetfs: do not WARN about excessively large memory allocations"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/DKTTMAS94IMH.2C6ERY0ZIVWVZ@nvidia.com
    - e0bdca7e8e96 "resource: fix lost wakeup when waiting for a muxed region"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260821-b4-resource-muxed-lost-wakeup-v1-1-37eb6473a76c@gmail.com
    - 74e170642be9 "fault-inject: fix dentry leak"
      - Authored by no role player, reviewed by a maintainer
      - Link: https://lore.kernel.org/20260821181527.3271414-1-mliang@purestorage.com
    - 5cd9d44e805f "mailmap: update email address for Bradley Morgan"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260825151157.4533-1-brads@mainlining.org
    - db989631cebb "fat: fix fat_ent_write() for reverting the value"
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lore.kernel.org/87ik4yz9fv.fsf_-_@mail.parknet.co.jp
    - ffee0a7bd992 "init: fix early boot crash with bare hostname parameter"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260826100904.296151-2-blum@kernel.org
    - 711b5e58a521 "ocfs2: fix deadlock in inline-data truncate transactions"
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lore.kernel.org/20260826112659.246574-1-joseph.qi@linux.alibaba.com
    - 06091020c469 "ocfs2: reject inconsistent local xattr entries"
      - Authored by no role player, reviewed by a maintainer
      - Link: https://lore.kernel.org/20260806085012.2650042-1-gality369@gmail.com
    - f4ffb598b229 "raid/kunit: enable RAID6 PQ and XOR benchmarks if KUNIT_ALL_TESTS=m"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/64c6e0191bd8ccef0074ffbb09bd0584680d710b.1787584360.git.geert@linux-m68k.org
    - 579274aa206e "ipc/mqueue: release notification resources during inode eviction"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260824042359.925145-1-4ncienth@gmail.com
    - 243c2c9ca623 "klist: avoid accesses after waking klist_remove()"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260827041708.31682-1-kmehltretter@gmail.com
    - 205494b4ba6d "lib/group_cpus: snapshot cluster masks to keep grouping hotplug invariant"
      - Authored by no role player, reviewed by nobody
    ...
    - series "selftests/membarrier: Skip an unregistered memory barrier test on Musl". (2 commits)
      - 0f55539f35b5 "selftests/membarrier: introduce helper to get membarrier command registrations" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - f1a3454fdb85 "selftests/membarrier: skip unpermitted membarrier command test if preregistered by libc" (1/2)
        - Authored by no role player, reviewed by nobody
    ...
    - series "squashfs: harden fragment index table sizing". (2 commits)
      - 4f4d022aa896 "squashfs: fix fragment index table sizing overflow on 32-bit" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - 2875d2ff50a7 "squashfs: make the fragment index table bounds check overflow-safe" (1/2)
        - Authored by no role player, reviewed by nobody
    ...
    - series "hung_task: Improve warning budget handling and task reporting", v10. (2 commits)
      - 396ab5aaedff "hung_task: reset warning budget when problem gets resolved" (0/2)
        - Authored by no role player, reviewed by a maintainer
      ...
      - f98097de7eb9 "hung_task: log summary line when warning budget is exhausted" (1/2)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260829145321.18423-3-atomlin@atomlin.com
    - 7cb473aaf966 "init, arch: make CONFIG_COMMAND_LINE_SIZE globally configurable"
      - Authored by no role player, reviewed by nobody
    ...
    - series "init, arch: make command line size and init arg limit configurable", v2. (2 commits)
      - 79dd21968659 "init/Kconfig: make config INIT_ENV_ARG_LIMIT user-configurable" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - be89df3e3942 "minmax.h: update the stale 'x' versus 'ux' comment" (1/2)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260817121613.3846511-1-zhanxusheng@xiaomi.com
    - 08b6108b0743 "lib: cleanup "fake" tristates in Kconfig"
      - Authored by no role player, reviewed by nobody
    ...
    - series "init: fix array boundary bugs in boot parameter parsing". (2 commits)
      - e1a9ac3e84a6 "init/main: fix off-by-one in argv_init cleanup" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - 05d8776fd485 "init/main: fix false-positive kernel panic on environment variable overwrite" (1/2)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260818045357.4123784-3-wfelipe@google.com
    - 213cb76290a7 "proc: report SIGEV_NONE in /proc/pid/timers if target task has died"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260816161216.984580-1-avagin@google.com
    - 9cba58822d97 "selftests/core: fix unshare_test with large fs.nr_open"
      - Authored by no role player, reviewed by nobody
    ...
    - series "Introduce arch_do_panic", v6. (3 commits)
      ...
      - 9e8d7bfcc1a7 "s390: implement arch_do_panic" (1/3)
        - Authored by no role player, reviewed by a maintainer
        - Link: https://lore.kernel.org/20260831-arch_do_panic-v6-2-a1e170a9e7fd@linux.ibm.com
      - c5abab556a59 "sparc: implement arch_do_panic" (2/3)
        - Authored by no role player, reviewed by no role player
        - Link: https://lore.kernel.org/20260831-arch_do_panic-v6-3-a1e170a9e7fd@linux.ibm.com
    - 1a68d361b991 "lib: decompress_unxz: make it obvious that there is no memory leak"
      - Authored by no role player, reviewed by a maintainer
    ...
    - 3b0e0f827440 "arch/Kconfig: fix dead conditions by removing dead options"
      - Authored by no role player, reviewed by no role player
    ...
    - series "dyndbg: fix incorrect mod_ct value in dynamic_debug_init()". (2 commits)
      - 5b79e5e64414 "dyndbg: fix incorrect mod_ct value in dynamic_debug_init()" (0/2)
        - Authored by no role player, reviewed by nobody
      ...
      - f9e9ff4e3414 "dyndbg: clean up dynamic_debug_init() to improve readability" (1/2)
        - Authored by no role player, reviewed by nobody
    ...
    - a3f0f3969adb "taskstats: fold the two pid/tgid handlers into one"
      - Authored by no role player, reviewed by no role player
    ...
    - series "ocfs2: validate suballoc slot and bit of metadata blocks", v3. (4 commits)
      - 965c8333fbd5 "ocfs2: restrict OCFS2_INVALID_SLOT suballoc slot to system inodes" (0/4)
        - Authored by a maintainer, reviewed by nobody
      ...
      - c8734267fd78 "ocfs2: validate suballoc bit during inode read" (1/4)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lore.kernel.org/20260901125221.1634686-3-joseph.qi@linux.alibaba.com
      - f56767bbb26c "ocfs2: validate suballoc slot and bit of xattr and dir index blocks" (2/4)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lore.kernel.org/20260901125221.1634686-4-joseph.qi@linux.alibaba.com
      - 60207bbe15eb "ocfs2: validate suballoc slot and bit of extent and refcount blocks" (3/4)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lore.kernel.org/20260901125221.1634686-5-joseph.qi@linux.alibaba.com
    - f96258faf2a7 "panic: remove the unneeded panic_print_get()"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260902114851.77062-1-feng.tang@linux.alibaba.com
    - e3c106792b5f "scripts/checkstack.pl: support llvm-objdump disassembly for x86"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260902-checkstack_llvm_objdump-v1-1-edb4eca5f163@google.com
    - d3c70cfaaa57 "selftests: uevent filtering: don't shrink the socket buffer"
      - Authored by no role player, reviewed by nobody
    ...
    - series "ocfs2: xattr bucket validation fixes", v2. (2 commits)
      - 8f0013b25ff1 "ocfs2: allow xattr bucket entries to span multiple blocks" (0/2)
        - Authored by a maintainer, reviewed by nobody
      ...
      - a83b2ae66ec0 "ocfs2: reject inconsistent xattr bucket during defrag" (1/2)
        - Authored by a maintainer, reviewed by nobody
        - Link: https://lore.kernel.org/20260903131313.2396208-3-joseph.qi@linux.alibaba.com
    - 64374daf13e9 "fat: calculate data area start without overflow"
      - Authored by no role player, reviewed by a maintainer
      - Link: https://lore.kernel.org/20260902170115.4162222-1-hengyul@cs.unc.edu
    - e36af00793e3 "ocfs2: skip uninitialized lockres in ocfs2_mark_lockres_freeing()"
      - Authored by a maintainer, reviewed by nobody
      - Link: https://lore.kernel.org/20260903104744.2164235-1-joseph.qi@linux.alibaba.com
    - 8864ccf06f3e "lib/plist: fix plist_requeue() corrupting order in the last bucket"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260903222456.1881786-1-handyhandyman.adam@gmail.com
    - b379cce8eb60 "mailmap: update email address for Ali Ahmet Memiş"
      - Authored by no role player, reviewed by nobody
      - Link: https://lore.kernel.org/20260905195000.556185-1-aliamemis@disroot.org
    - 4560f8b7836b "ocfs2: validate dr_fs_generation of dir index root blocks"
      - Authored by a maintainer, reviewed by no role player
      - Link: https://lore.kernel.org/20260905142144.2869105-1-joseph.qi@linux.alibaba.com
    - 5bdbca5b8353 "ocfs2: validate dl_blkno and dl_fs_generation of dir index leaf blocks"
      - Authored by a maintainer, reviewed by no role player
    ...
    - series "checkpatch: userspace improvements", v6. (4 commits)
      - a4c54fd9d8d4 "checkpatch: add more userspace directories to is_userspace()" (0/4)
        - Authored by no role player, reviewed by nobody
      ...
      - 5bec936804f1 "checkpatch: ignore <inttypes.h> format macros for userspace tools" (1/4)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260904110230.1219037-3-pvorel@suse.cz
      - 3eab6499bf68 "checkpatch: add --userspace to force userspace rules" (2/4)
        - Authored by no role player, reviewed by nobody
        - Link: https://lore.kernel.org/20260904110230.1219037-4-pvorel@suse.cz
      - 31b3122f86c0 "checkpatch: skip kernel specific checks for userspace" (3/4)
        - Authored by no role player, reviewed by nobody
    ...
    - series "module: Extend module_blacklist parameter to built-in modules", v11. (3 commits)
      - 3595d45fded0 "module: treat dashes and underscores interchangeably in module_blacklist" (0/3)
        - Authored by a reviewer, reviewed by nobody
      ...
      - d5bd142c8ee4 "module: extend module_blacklist parameter to built-in modules" (1/3)
        - Authored by a reviewer, reviewed by nobody
        - Link: https://lore.kernel.org/20260908203230.401020-3-atomlin@atomlin.com
      - 3f78fe3dfa18 "module: rename module_blacklist to module_denylist" (2/3)
        - Authored by a reviewer, reviewed by nobody
        - Link: https://lore.kernel.org/20260908203230.401020-4-atomlin@atomlin.com
    - 022dd1af3b70 "bootconfig: remove redundant assignment in xbc_parse_array()"
      - Authored by no role player, reviewed by a maintainer
      - Link: https://lore.kernel.org/20260910163051.1973775-1-ekffu200098@gmail.com
    - b9a4a8f475c5 "tools/bootconfig: fix integer overflow and truncation in size checks"
      - Authored by no role player, reviewed by no role player
    ...
    - series "bootconfig: Reject unexpected data after null character and cleanups", v2. (4 commits)
      - 3d2efbc7dd0d "bootconfig: reject unexpected data after null character" (0/4)
        - Authored by no role player, reviewed by no role player
    ...
    - 36b26cea5574 "resource: replace open coded resource_overlaps()"
      - Authored by no role player, reviewed by no role player
      - Link: https://lore.kernel.org/20260915085353.3518153-1-andriy.shevchenko@linux.intel.com
    - c7ee54cc77c2 "CREDITS: fix the ordering and other issues"
      - Authored by no role player, reviewed by nobody
